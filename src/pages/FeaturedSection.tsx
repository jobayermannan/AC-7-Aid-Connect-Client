...
const FeaturedSection = () => {
   ...
   // Filter to only include featured supplies if necessary
   // Assuming the API already filters featured supplies, this step might be redundant
    ...
    <div>
      <div className="py-12 bg-gray-900">
        ...
        <div className="mt-20 text-center">
          ...
          <Button
                      borderRadius="1.7rem"
                      className="bg-black   px-2 py-2 text-sm"
                    >
